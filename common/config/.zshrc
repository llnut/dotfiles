...
export PATH=$DOTFILES/common/config/bin:$HOME/bin:$HOME/.local/bin:/usr/local/bin:/usr/local/sbin:/usr/bin:/bin:/usr/sbin:/sbin:$HOME/.composer/vendor/bin/:$HOME/go/bin:$PATH
...
ZSH_CUSTOM=$DOTFILES/common/config/oh-my-zsh-plugins
...
for config ($DOTFILES/common/config/zsh/*.zsh) source $config
...
fpath=($DOTFILES/common/config/oh-my-zsh-plugins/functions/ $fpath)
