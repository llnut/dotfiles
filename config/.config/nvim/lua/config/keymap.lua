...
-- Switch buffers (overridden by bufferline in plugin keys)
...
-- Strip trailing whitespace (<leader>rw)
keymap("", "<leader>rw", ":lua require('util.function').strip_white_space()<CR>", option)
...
-- default show_documentation (for vim/help/man/Cargo.toml; LSP buffers use 0.11 default K)
