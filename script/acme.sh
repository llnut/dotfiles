...
LATEST_URL="https://github.com/acmesh-official/acme.sh/releases/latest"
LATEST_URL=`github_latest_url "$LATEST_URL"`
LATEST_TAG=`echo $LATEST_URL | awk -F '/' '{print $NF}'`
REMOTE_FILE_PREFIX="${LATEST_TAG}"
LATEST_URL="https://github.com/acmesh-official/acme.sh/archive/refs/tags/"
