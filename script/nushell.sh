...
REMOTE_FILE_PREFIX="nu-${LATEST_TAG}-x86_64-unknown-linux-musl"

BIN=("nu" "nu_plugin_custom_values" "nu_plugin_example" "nu_plugin_formats" "nu_plugin_gstat" "nu_plugin_inc" "nu_plugin_query" "nu_plugin_polars" "nu_plugin_stress_internals")
BIN_LINK=($BIN)
