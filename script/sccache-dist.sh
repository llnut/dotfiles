...
echo "Installing sccache-dist..."

SCRIPT_PATH="$( cd "$( dirname "$0" )" >/dev/null 2>&1 && pwd )"
source $SCRIPT_PATH/util.sh

SAVE_DIR="sccache-dist"
SAVE_FILE_PREFIX="$SAVE_DIR"
SAVE_FILE_SUFFIX=".tar.gz"
BIN_PATH="$SAVE_PATH/$SAVE_DIR"
BIN=("sccache-dist")

LATEST_URL="https://github.com/mozilla/sccache/releases/latest"
...
REMOTE_FILE_PREFIX="sccache-dist-${LATEST_TAG}-x86_64-unknown-linux-musl"
