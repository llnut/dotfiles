...
LATEST_URL="https://github.com/rustwasm/wasm-bindgen/releases/latest"
LATEST_URL=`github_latest_url "$LATEST_URL"`
LATEST_TAG=`echo $LATEST_URL | awk -F '/' '{print $NF}'`
REMOTE_FILE_PREFIX="wasm-bindgen-${LATEST_TAG}-x86_64-unknown-linux-musl"
